...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView,
        ...
        String string = mContext.getResources().getString(R.string.TotalSteps);
        mDateStepCountText.setText(mStepCountList.get(position).mDate + " "+  string +" "  + mStepCountList.get(position).mStepCount);
        return convertView;
    }
}